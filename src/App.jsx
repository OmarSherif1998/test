...
const sidebarIcons = [
  { id: 1, label: 'storage', Icon: StorageOutlinedIcon },
  { id: 2, label: 'schema', Icon: SchemaOutlinedIcon },
  { id: 3, label: 'upload', Icon: CloudUploadOutlinedIcon },
  { id: 4, label: 'network', Icon: SettingsEthernetOutlinedIcon },
]
